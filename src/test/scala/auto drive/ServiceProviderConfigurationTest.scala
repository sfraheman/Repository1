...
import auto drive.reader.mycomponent.MyStreamReaderImpl
import auto drive.transformer.mycomponent.MyStreamTransformerImpl
import auto drive.writer.mycomponent.MyStreamWriterImpl
